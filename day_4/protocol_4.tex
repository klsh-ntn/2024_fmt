...
% тур 4: без Иры Аршуковой, без Серёжи Ламзина, без Яна Шапиро, без Артёма Майдурова

\newcommand{\blockofjudges}{ %
% day 1
% table 1
\protocol{1.1}{$\phi$}{$\omega$}{Марина Хмельницкая}{Тима Спрыжков} %
%
% table 2
\protocol{1.2}{$\gamma$}{$\pi$}{Настя Судницына}{Рома Лисин, Александр Сырбачев}  % 
%
% table 3
\protocol{2.1}{$\psi$}{$\xi$}{Витя Зелинский}{Даня Снегур, Михаил Красков} %  
%
% table 4
\protocol{2.2}{$\kappa$}{$\sigma$}{Андрей Трегубович}{Слава Шестаков, Роберт Гринштейн} % 
%
% table 5
\protocol{3.1}{$\alpha$}{$\nu$}{Егор Лунёв}{Вика Луковская, Макс Федянов} % 
%
% table 6
\protocol{3.2}{$\varepsilon$}{$\theta$}{Вова Тимофеев}{Егор Скурковин, Саша Тимошков} %
%
% table 7
\protocol{вк}{$\delta$}{$\mu$}{Вова Фёдоров}{Ваня Адо, Коля Гулицкий} %  
%
% table 8
\protocol{Гарвард}{$\beta$}{$\rho$}{Всеволод Кабриц}{Антонина Шарковская, Полина Смирнова} % 
%
% table 9 
\protocol{Кэмбридж}{$\chi$}{$\lambda$}{Вера Михеева}{Лиза Моисеева} % 
%
% table 10
\protocol{Сорбонна}{$\eta$}{$\iota$}{Павел Рябенко}{Антон Шейкин} % 
%
% table 11
\protocol{БХ}{$o$}{$\tau$}{Влад Сидельников}{Боря Демешев} % 
}


% пожелалки на финал: Макс Федянов и Вера Михеева
