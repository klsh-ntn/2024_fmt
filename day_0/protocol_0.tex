...
% пустой протокол для ручного заполнения
% day 0
\protocol{}{$\psi$}{$\varepsilon$}{Серёжа Ламзин}{Роберт Гринштейн} %

\protocol{}{$\omega$}{$\theta$}{Ваня Адо}{Егор Скурковин}

\protocol{}{$\pi$}{$\phi$}{Даня Снегур}{Андрей Трегубович}

\protocol{}{$\chi$}{$\nu$}{Антон Шейкин}{Саша Тимошков}

\protocol{}{$\rho$}{$\mu$}{Миша Красков}{Вова Тимофеев}

\protocol{}{$\sigma$}{$\tau$}{Ян Шапиро}{Рома Лисин}

\protocol{}{$\delta$}{$\lambda$}{Артём Майдуров}{Марина Хмельницкая}

\protocol{}{$\kappa$}{$\xi$}{Макс Федянов}{Настя Судницына}

\protocol{}{$\alpha$}{$\eta$}{Слава Шестаков}{Витя Зелинский}

\protocol{}{o}{$\gamma$}{Тоня Шарковская}{Тима Спрыжков}

\protocol{}{$\beta$}{$\iota$}{Лиза Моисеева}{Полина Смирнова}
