...
\newcommand{\tour}{ФМТ тур 3} % номер тура
...
% day 1
% table 1
\protocol{1.1}{$\pi$}{$\omega$}{Рома Лисин}{Ян Шапиро, Серёжа Ламзин} %
%
% table 2
\protocol{1.2}{$\xi$}{$\phi$}{Тима Спрыжков}{Витя Зелинский, Александр Сырбачев}  % 
%
% table 3
\protocol{2.1}{$\gamma$}{$\varepsilon$}{Антон Шейкин}{Роберт Гринштейн, Вера Михеева} %  
%
% table 4
\protocol{2.2}{$\psi$}{$\delta$}{Коля Гулицкий}{Марина Хмельницкая, Егор Лунёв} % 
%
% table 5
\protocol{3.1}{$\theta$}{$\nu$}{Даня Снегур}{Андрей Трегубович, Макс Федянов} % 
%
% table 6
\protocol{3.2}{$\rho$}{$\kappa$}{Ваня Адо}{Влад Сидельников, Саша Тимошков} %
%
% table 7
\protocol{вк}{$\sigma$}{$\chi$}{Полина Смирнова}{Всеволод Кабриц, Вова Тимофеев} %  
%
% table 8
\protocol{Гарвард}{$\alpha$}{$\eta$}{Михаил Красков}{Антонина Шарковская, Вова Фёдоров} % 
%
% table 9 
\protocol{Кэмбридж}{$\beta$}{$\lambda$}{Слава Шестаков}{Настя Судницына, Майдуров Артём} % 
%
% table 10
\protocol{Сорбонна}{$\mu$}{$\tau$}{Вика Луковская}{Павел Рябенко} % 
%
% table 11
\protocol{БХ}{$o$}{$\iota$}{Егор Скурковин}{Боря Демешев} % 
}
